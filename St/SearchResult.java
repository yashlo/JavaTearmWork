...
String password = "";
String[] columnNames = {"itemNumber", "itemType", "itemPrice", "itemQty"};
...
label = new JLabel("Enter your Item ID");
...
con=DriverManager.getConnection("jdbc:mysql://localhost:3306/userregist?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","root","");
 ...
 ps.setString(1,textbox.getText());
 rs = ps.executeQuery();
// rs = ps.executeQuery();
int i =0;
if(rs.next())
...
itemQty = rs.getString("itemQty");
model.addRow(new Object[]{itemNumber, itemType, itemPrice, itemQty});
i++;
}
if(i <1)
{
